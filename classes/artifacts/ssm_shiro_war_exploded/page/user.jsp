...
<shiro:user>
    ...
    <div style="margin-left: 5%;">
        ...
        <div style="margin-left: 21%;margin-right: 16%;margin-top: -8%;width: 100%" class="text-center">
                ...
                <div class="modal-body">
                    ...
                    <div style="float: right;width: 55%;margin-top: -2%;">
                        <li class="title">
                            ...
                            <textarea class="info" style="margin: 0px;width: 326px;height: 257px;word-wrap: normal;">
